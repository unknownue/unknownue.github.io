...
## 描述翻译
#20934 [导致了](#22915)我们的二进制文件大小增加。通过将 register_component 的通用部分提取出来，允许更多代码共享，这在一个 release 版本的 `3d_scene` 上回收了 4 MiB。根据我的估计，这其中有 0.9 MiB 属于因 Resources as Components 导致的 8.3 MiB 增长部分。
