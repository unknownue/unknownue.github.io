...
The changes follow a consistent pattern: replacing division operations with explicit const arithmetic and using `Vec2::new()` instead of vector division to maintain const correctness.
